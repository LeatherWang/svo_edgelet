...
void BenchmarkNode::runFromFolder()
{
    ...
    LoadImages("/media/leather/娱乐/data_set/euroc/MH_01_easy/mav0/cam0/data",
               "/media/leather/娱乐/data_set/euroc/MH_01_easy/mav0/cam1/data",
               "MH01.txt", vstrImageLeft, vstrImageRight, vTimeStamp);
cout<<"here"<<endl;
